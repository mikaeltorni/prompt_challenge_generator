...
- Your task is not to provide examples, input variables or test cases. These will be processed by seperate agents later on from your input. Do not generate these, focus only on the problem statement.
